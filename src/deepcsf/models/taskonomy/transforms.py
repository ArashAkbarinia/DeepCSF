...
from .taskonomy_network import TaskonomyEncoder, TaskonomyDecoder, TaskonomyNetwork, \
    TASKONOMY_PRETRAINED_URLS, TASKS_TO_CHANNELS, PIX_TO_PIX_TASKS, DONT_APPLY_TANH_TASKS
...
class VisualPrior(object):
    ...
    def max_coverage_transform(cls, img, k=4, device=default_device):
        ...
        return cls.to_representation(img, feature_tasks=VisualPrior.max_coverate_featuresets[k - 1],
                                     device=device)
